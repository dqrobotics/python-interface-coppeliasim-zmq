...
1.  Murilo M. Marinho        (murilomarinho@ieee.org)
        ...
        - Move module out of main dqrobotics module. Removed redundant c-style cast.
...
void init_DQ_CoppeliaSimInterfaceZMQ_py(py::module& m)
{
    ...
    c.def("set_synchronous", &DQ_CoppeliaSimInterfaceZMQ::set_synchronous, "Sets synchronous mode");
    ...
    c.def("get_object_translation",
                           &DQ_CoppeliaSimInterfaceZMQ::get_object_translation,
                           "Gets object translation.");

    c.def("set_object_translation",
                           &DQ_CoppeliaSimInterfaceZMQ::set_object_translation,
                           "Sets object translation.");

    c.def("get_object_rotation",
                           &DQ_CoppeliaSimInterfaceZMQ::get_object_rotation,
                           "Gets object rotation.");

    c.def("set_object_rotation",
                           &DQ_CoppeliaSimInterfaceZMQ::set_object_rotation,
                           "Sets object rotation.");

    c.def("get_object_pose",
                           &DQ_CoppeliaSimInterfaceZMQ::get_object_pose,
                           "Gets object pose.");

    c.def("set_object_pose",
                           &DQ_CoppeliaSimInterfaceZMQ::set_object_pose,
                           "Sets object pose.");

    c.def("get_object_handle",
                            &::DQ_CoppeliaSimInterfaceZMQ::get_object_handle,
    ...
    c.def("set_joint_positions",
                           &DQ_CoppeliaSimInterfaceZMQ::set_joint_positions,
                           "Set joint positions");

    c.def("set_joint_target_positions",
                           &DQ_CoppeliaSimInterfaceZMQ::set_joint_target_positions,
                           "Set joint positions");

    c.def("get_joint_positions",
                           &DQ_CoppeliaSimInterfaceZMQ::get_joint_positions,
                           "Get joint positions");

    c.def("get_joint_velocities",
                            &DQ_CoppeliaSimInterfaceZMQ::get_joint_velocities,
                            "gets the joint velocities in the CoppeliaSim scene.");

    c.def("set_joint_target_velocities",
                            &DQ_CoppeliaSimInterfaceZMQ::set_joint_target_velocities,
    ...
    c.def("get_joint_torques",
                            &DQ_CoppeliaSimInterfaceZMQ::get_joint_torques,
                            "gets the joint torques in the CoppeliaSim scene.");

    c.def("set_joint_torques",
                            &DQ_CoppeliaSimInterfaceZMQ::set_joint_torques,
